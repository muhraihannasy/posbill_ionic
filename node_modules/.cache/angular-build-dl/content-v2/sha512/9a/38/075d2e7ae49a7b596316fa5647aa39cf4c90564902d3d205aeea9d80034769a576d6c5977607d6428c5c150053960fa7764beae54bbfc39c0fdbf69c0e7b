(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["outlet-edit-outlet-edit-module"], {
    ...
    /***/
    function M06G(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "OutletEditPageModule", function () {
        return OutletEditPageModule;
      });
      /* harmony import */
      ...
      var _outlet_edit_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./outlet-edit-routing.module */
      "WMSC");
      /* harmony import */


      var _outlet_edit_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./outlet-edit.page */
      "mRQY");

      var OutletEditPageModule = /*#__PURE__*/_createClass(function OutletEditPageModule() {
        _classCallCheck(this, OutletEditPageModule);
      });

      OutletEditPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _outlet_edit_routing_module__WEBPACK_IMPORTED_MODULE_5__["OutletEditPageRoutingModule"]],
    ...
    /***/
    function WMSC(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "OutletEditPageRoutingModule", function () {
        return OutletEditPageRoutingModule;
      });
      /* harmony import */
      ...
      var _outlet_edit_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./outlet-edit.page */
      "mRQY");
      ...
      var OutletEditPageRoutingModule = /*#__PURE__*/_createClass(function OutletEditPageRoutingModule() {
        _classCallCheck(this, OutletEditPageRoutingModule);
      });

      OutletEditPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function mEx(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function mRQY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "OutletEditPage", function () {
        return OutletEditPage;
      });
      /* harmony import */
      ...
      var _raw_loader_outlet_edit_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./outlet-edit.page.html */
      "m/Ex");
      /* harmony import */


      var _outlet_edit_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./outlet-edit.page.scss */
      "mjlQ");
      /* harmony import */
      ...
      var OutletEditPage = /*#__PURE__*/function () {
        function OutletEditPage(storage, http, global, router, loadingController, platform, nativePageTransitions, route, alertController) {
          var _this = this;

          _classCallCheck(this, OutletEditPage);
        ...
        _createClass(OutletEditPage, [{
          ...
          value: function process() {
            ...
            this.storage.getObject('auth').then(function (auth) {
              ...
              var postData = {
                id: _this4.id,
                name: _this4.outlet.name,
                address: _this4.outlet.address,
                phone: _this4.outlet.phone
              };

              _this4.http.post(_this4.global.base_url + 'auth/outlet/edit', postData, options).subscribe(function (data) {
                console.log(data);

                if (data.status == 0) {
                  _this4.global.toastPresent(data.message);

                  _this4.router.navigate(['/outlet']);
                } else {
                  console.log(data);
                }
          ...
          value: function _delete() {
            ...
            this.storage.getObject('auth').then(function (auth) {
              ...
              _this6.http.post(_this6.global.base_url + 'auth/outlet/delete', postData, options).subscribe(function (data) {
                console.log(data);

                if (data.status == 0) {
                  _this6.global.toastPresent(data.message);

                  _this6.router.navigate(['/outlet']);
                } else {
                  console.log(data);
                }
      ...
      OutletEditPage.ctorParameters = function () {
        return [{
      ...
      OutletEditPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function mjlQ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=outlet-edit-outlet-edit-module-es5.js.map