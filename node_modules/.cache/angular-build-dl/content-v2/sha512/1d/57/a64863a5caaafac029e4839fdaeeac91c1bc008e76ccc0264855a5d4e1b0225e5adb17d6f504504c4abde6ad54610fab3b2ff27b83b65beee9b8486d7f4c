  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["user-user-module"], {
    ...
    function Wfj(module, __webpack_exports__, __webpack_require__) {
      ...
      var UserPage = /*#__PURE__*/function () {
        function UserPage(storage, http, global, router, loadingController, platform, nativePageTransitions) {
        ...
        _createClass(UserPage, [{
          ...
          value: function getData() {
            ...
            this.storage.getObject('auth').then(function (auth) {
              ...
              _this2.http.post(_this2.global.base_url + 'auth/user/list', null, options).subscribe(function (data) {
                console.log(data);
      ...
      UserPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        selector: 'app-user',
    ...
    function Yu5h(module, __webpack_exports__, __webpack_require__) {
      ...
      var UserPageRoutingModule = /*#__PURE__*/_createClass(function UserPageRoutingModule() {
