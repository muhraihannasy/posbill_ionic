(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! D:\Ionic\posbill_ionic\src\main.ts */
      "zUnb");
      /***/
    },
    ...
    function S36L(module, __webpack_exports__, __webpack_require__) {
      ...
      var NotificationService = /*#__PURE__*/function () {
        function NotificationService(toastController) {
        ...
        _createClass(NotificationService, [{
          ...
          value: function showNotification(header, message) {
        ...
        _createClass(AppComponent, [{
          ...
          value: function registerBackButton() {
            ...
            this.platform.backButton.subscribeWithPriority(10, function () {
              var thisUrl = _this2.router.url;
              var splitUrl = thisUrl.split("/");

              if (_this2.router.url == "/tabs/tab-pos" || _this2.router.url == "/login") {
                App.exitApp();
              } else if (_this2.router.url == "/register") {
                _this2.router.navigate(["/login"]);
              } else if (_this2.router.url == "/tabs/tab-order" || _this2.router.url == "/tabs/tab-report" || _this2.router.url == "/tabs/tab-catalog" || _this2.router.url == "/tabs/tab-setting" || _this2.router.url == "/payment-options" || _this2.router.url == "/booking") {
                _this2.router.navigate(["/tabs/tab-pos"]);
              } else if (splitUrl[1] == "orders-detail") {
                _this2.router.navigate(["/tabs/tab-order"]);
              } else if (_this2.router.url == "/catalog-category" || _this2.router.url == "/catalog-product") {
                _this2.router.navigate(["/tabs/tab-catalog"]);
              } else if (_this2.router.url == "/setting-sale" || _this2.router.url == "/setting-payment" || _this2.router.url == "/setting-discount" || _this2.router.url == "/setting-format" || _this2.router.url == "/setting-printer" || _this2.router.url == "/outlet" || _this2.router.url == "/customer" || _this2.router.url == "/user" || _this2.router.url == "/account" || _this2.router.url == "/subscription") {
                _this2.router.navigate(["/tabs/tab-setting"]);
              } else if (_this2.router.url == "/catalog-category-add" || splitUrl[1] == "catalog-category-edit") {
                _this2.router.navigate(["/catalog-category"]);
              } else if (_this2.router.url == "/catalog-product-add" || splitUrl[1] == "catalog-product-edit") {
                _this2.router.navigate(["/catalog-product"]);
              } else if (_this2.router.url == "/discount-add" || splitUrl[1] == "discount-edit") {
                _this2.router.navigate(["/setting-discount"]);
              } else if (_this2.router.url == "/outlet-add" || splitUrl[1] == "outlet-edit") {
                _this2.router.navigate(["/outlet"]);
              } else if (_this2.router.url == "/user-add" || splitUrl[1] == "user-edit") {
                _this2.router.navigate(["/user"]);
              } else if (_this2.router.url == "/customer-add" || splitUrl[1] == "customer-edit") {
                _this2.router.navigate(["/customer"]);
              } else if (splitUrl[1] == "booking-detail") {
                _this2.router.navigate(["/booking"]);
              } else if (splitUrl[1] == "select-customer" || _this2.router.url == "/select-discount") {
                _this2.router.navigate(["/payment-options"]);
              } else if (splitUrl[1] == "report-sales" || splitUrl[1] == "report-product-sales") {
                _this2.router.navigate(["/tabs/tab-report"]);
              } else if (_this2.router.url == "/account-edit") {
    ...
    function dVwY(module, __webpack_exports__, __webpack_require__) {
      ...
      var GlobalService = /*#__PURE__*/function () {
        function GlobalService(http, loadingController, toastController, storage) {
          ...
          this.domain = "https://145a-103-3-221-80.ngrok-free.app/";
                    ...
                    return this.toastController.create({
                      ...
                      buttons: [{
                        ...
                        handler: function handler() {
                          ...
                          _this3.toastController.dismiss();
                        }
                      }]
                    });
    ...
    function og4U(module, __webpack_exports__, __webpack_require__) {
      ...
      var FcmService = /*#__PURE__*/function () {
        function FcmService(router, http, global, notification) {
        ...
        _createClass(FcmService, [{
          ...
          value: function registerPush() {
            ...
            PushNotifications.addListener("registration", function (token) {
              ...
              _this4.http.post(_this4.global.base_url + "auth/fcm/add", postData, options).subscribe(function (data) {
                console.log(data);
              }, function (error) {
                console.log(error);
              });
            ...
            PushNotifications.addListener("pushNotificationReceived", function (notification) {
              var header = "Header";
              var message = "<strong>Ada Pesanan Nich</strong>";

              _this4.notification.showNotification(header, message);
            });
            PushNotifications.addListener("pushNotificationActionPerformed", function (notification) {
              ...
              if (data.detailsId) {
                _this4.router.navigateByUrl("/orders-detail/".concat(data.detailsId, "/pos"));
              }
            });
          }
        }]);
