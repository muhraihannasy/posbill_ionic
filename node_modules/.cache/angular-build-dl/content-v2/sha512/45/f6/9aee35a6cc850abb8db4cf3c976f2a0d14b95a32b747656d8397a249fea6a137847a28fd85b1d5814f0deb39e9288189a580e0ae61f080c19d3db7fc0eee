...
module.exports = __webpack_require__(/*! D:\Ionic\posbill_ionic\src\main.ts */"zUnb");
...
let NotificationService = class NotificationService {
    ...
    showNotification(header, message, buttons = []) {
...
let FcmService = class FcmService {
    constructor(router, http, global, notification) {
        this.router = router;
        this.http = http;
        this.global = global;
