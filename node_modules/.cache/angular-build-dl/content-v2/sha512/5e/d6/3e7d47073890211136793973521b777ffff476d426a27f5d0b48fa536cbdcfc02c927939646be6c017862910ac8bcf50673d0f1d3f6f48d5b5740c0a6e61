(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["payment-finish-payment-finish-module"], {
    /***/
    "2xqe":
    /*!*********************************************************!*\
      !*** ./src/app/payment-finish/payment-finish.module.ts ***!
      \*********************************************************/

    /*! exports provided: PaymentFinishPageModule */

    /***/
    function xqe(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PaymentFinishPageModule", function () {
        return PaymentFinishPageModule;
      });
      /* harmony import */
      ...
      var _payment_finish_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./payment-finish-routing.module */
      "ZyXo");
      /* harmony import */


      var _payment_finish_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./payment-finish.page */
      "sQ7U");

      var PaymentFinishPageModule = /*#__PURE__*/_createClass(function PaymentFinishPageModule() {
        _classCallCheck(this, PaymentFinishPageModule);
      });

      PaymentFinishPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _payment_finish_routing_module__WEBPACK_IMPORTED_MODULE_5__["PaymentFinishPageRoutingModule"]],
        declarations: [_payment_finish_page__WEBPACK_IMPORTED_MODULE_6__["PaymentFinishPage"]]
      })], PaymentFinishPageModule);
      /***/
    },
    ...
    "M1dF":
    /*!*********************************************************!*\
      !*** ./src/app/payment-finish/payment-finish.page.scss ***!
      \*********************************************************/

    /*! exports provided: default */

    /***/
    function M1dF(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    "ZyXo":
    /*!*****************************************************************!*\
      !*** ./src/app/payment-finish/payment-finish-routing.module.ts ***!
      \*****************************************************************/

    /*! exports provided: PaymentFinishPageRoutingModule */

    /***/
    function ZyXo(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PaymentFinishPageRoutingModule", function () {
        return PaymentFinishPageRoutingModule;
      });
      /* harmony import */
      ...
      var _payment_finish_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./payment-finish.page */
      "sQ7U");

      var routes = [{
        path: '',
        component: _payment_finish_page__WEBPACK_IMPORTED_MODULE_3__["PaymentFinishPage"]
      }];

      var PaymentFinishPageRoutingModule = /*#__PURE__*/_createClass(function PaymentFinishPageRoutingModule() {
        _classCallCheck(this, PaymentFinishPageRoutingModule);
      });

      PaymentFinishPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    "evt7":
    /*!***********************************************************************************************!*\
      !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/payment-finish/payment-finish.page.html ***!
      \***********************************************************************************************/

    /*! exports provided: default */

    /***/
    function evt7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    "sQ7U":
    /*!*******************************************************!*\
      !*** ./src/app/payment-finish/payment-finish.page.ts ***!
      \*******************************************************/

    /*! exports provided: PaymentFinishPage */

    /***/
    function sQ7U(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PaymentFinishPage", function () {
        return PaymentFinishPage;
      });
      /* harmony import */
      ...
      var _raw_loader_payment_finish_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./payment-finish.page.html */
      "evt7");
      /* harmony import */


      var _payment_finish_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./payment-finish.page.scss */
      "M1dF");
      /* harmony import */
      ...
      var PaymentFinishPage = /*#__PURE__*/function () {
        function PaymentFinishPage(platform, bluetoothSerial, nativePageTransitions) {
          _classCallCheck(this, PaymentFinishPage);
        ...
        _createClass(PaymentFinishPage, [{
          key: "ngOnInit",
          ...
          value: function printReceipt() {
            ...
            this.connectToBluetoothPrinter().subscribe(function (_) {
              ...
              _this.bluetoothSerial.write(content).then(function (_) {
                //3. Print successful
                ...
                _this.disconnectBluetoothPrinter();
              }, function (err) {
      ...
      PaymentFinishPage.ctorParameters = function () {
        return [{
      ...
      PaymentFinishPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        selector: 'app-payment-finish',
        template: _raw_loader_payment_finish_page_html__WEBPACK_IMPORTED_MODULE_1__["default"],
        styles: [_payment_finish_page_scss__WEBPACK_IMPORTED_MODULE_2__["default"]]
      })], PaymentFinishPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=payment-finish-payment-finish-module-es5.js.map