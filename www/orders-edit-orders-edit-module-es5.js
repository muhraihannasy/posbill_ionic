(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["orders-edit-orders-edit-module"], {
    ...
    /***/
    function dCe(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function BuK7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "OrdersEditPageModule", function () {
        return OrdersEditPageModule;
      });
      /* harmony import */
      ...
      var _orders_edit_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./orders-edit-routing.module */
      "E1lP");
      /* harmony import */


      var _orders_edit_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./orders-edit.page */
      "ZIGR");

      var OrdersEditPageModule = /*#__PURE__*/_createClass(function OrdersEditPageModule() {
        _classCallCheck(this, OrdersEditPageModule);
      });

      OrdersEditPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _orders_edit_routing_module__WEBPACK_IMPORTED_MODULE_5__["OrdersEditPageRoutingModule"]],
    ...
    /***/
    function E1lP(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "OrdersEditPageRoutingModule", function () {
        return OrdersEditPageRoutingModule;
      });
      /* harmony import */
      ...
      var _orders_edit_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./orders-edit.page */
      "ZIGR");
      ...
      var OrdersEditPageRoutingModule = /*#__PURE__*/_createClass(function OrdersEditPageRoutingModule() {
        _classCallCheck(this, OrdersEditPageRoutingModule);
      });

      OrdersEditPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function ZIGR(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "OrdersEditPage", function () {
        return OrdersEditPage;
      });
      /* harmony import */
      ...
      var _raw_loader_orders_edit_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./orders-edit.page.html */
      "d8Ql");
      /* harmony import */


      var _orders_edit_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./orders-edit.page.scss */
      "+dCe");
      /* harmony import */
      ...
      var OrdersEditPage = /*#__PURE__*/function () {
        function OrdersEditPage(storage, http, global, router, loadingController, platform, route, bluetoothSerial, nativePageTransitions, alertController, DatecsPrinter, base64ToGallery) {
          var _this = this;

          _classCallCheck(this, OrdersEditPage);
        ...
        _createClass(OrdersEditPage, [{
            ...
            this.platform.ready().then(function () {
              ...
              _this2.storage.getObject('order').then(function (data) {
                if (data != null) {
                  ...
                  content += "Pelanggan : " + _this2.order.customer.name + " \n";
                  content += "--------------------------------\n";
                  ...
                  contentWA += "Pelanggan : " + _this2.order.customer.name + " %0a";
                  contentWA += "--------------------------------%0a";
                  ...
                  printHeader += "Pelanggan : " + _this2.order.customer.name + " \n";
                  printHeader += "--------------------------------\n";
                    ...
                    return this.alertController.create({
                      ...
                      buttons: [{
                        ...
                        handler: function handler(data) {
                          ...
                          window.open("https://wa.me/" + numberStr + "?text=" + _this7.contentWA);
                  ...
                  case 0:
                    ...
                    return this.alertController.create({
                      ...
                      buttons: [{
                        ...
                        text: 'Simpan',
                        handler: function handler(data) {
                          _this8.global.loadingPresent('mengubah item...');

                          _this8.order.order_item[i].qty = data.qty;
                          _this8.order.order_item[i].note = data.note;
                          ...
                          _this8.http.post(_this8.global.base_url + 'auth/order/edit_item', postData, options).subscribe(function (data) {
                            console.log(data);

                            if (data.status == 0) {
                              _this8.storage.getObject('order').then(function (storageOrder) {
                                if (storageOrder != null) {
                                  ...
                                  _this8.storage.setObject('order', storageOrder);

                                  _this8.global.toastPresent('Item pesanan berhasil disimpan!');
                    ...
                    return this.alertController.create({
                      ...
                      buttons: [{
                        ...
                        handler: function handler(dataHandler) {
                          _this9.global.loadingPresent('menghapus item...');
                          ...
                          _this9.http.post(_this9.global.base_url + 'auth/order/delete_item', postData, options).subscribe(function (data) {
                            console.log(data);

                            if (data.status == 0) {
                              _this9.storage.getObject('order').then(function (storageOrder) {
                                if (storageOrder != null) {
                                  var orderIndex = storageOrder.findIndex(function (x) {
                                  ...
                                  _this9.storage.setObject('order', storageOrder);

                                  _this9.global.toastPresent('Item pesanan berhasil dihapus!');
          ...
          value: function gotoPOS() {
            ...
            this.router.navigate(['/tabs/blank']).then(function () {
              _this10.router.navigate(['/tabs/tab-pos']);
            });
          }
        }, {
            ...
            this.storage.getObject('order').then(function (data) {
              if (data != null) {
                var orderIndex = data.findIndex(function (x) {
                  return x.id === _this13.id;
                });
                data[orderIndex].status = 'Canceled';

                _this13.storage.setObject('order', data);

                var reqHeader = new _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpHeaders"]({
                  'Content-Type': 'application/json',
                  'Authorization': 'Bearer ' + _this13.auth.token
                });
                var options = {
                  headers: reqHeader
                };
                ...
                _this13.http.post(_this13.global.base_url + 'auth/order/cancel', postData, options).subscribe(function (data) {
                  console.log(data);

                  if (data.status == 0) {
                    _this13.global.toastPresent(data.message);

                    _this13.router.navigate(['/tabs/blank']).then(function () {
                      _this13.router.navigate(['/tabs/tab-order']);
      ...
      OrdersEditPage.ctorParameters = function () {
        return [{
      ...
      OrdersEditPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function d8Ql(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=orders-edit-orders-edit-module-es5.js.map